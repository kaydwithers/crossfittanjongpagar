...
class rhc_visual_composer {
	var $pop_input = false;
	function rhc_visual_composer($args=array()){
		//------------
		$defaults = array(
			'url'				=> ''
		);
...
//		$vc_category = __( "Calendarize it!", "rhc");
		...
		vc_map( array(
			...
			"description"		=> __("Insert Calendar","rhc"),
		...
		vc_map( array(
			...
			"category" 			=> $vc_category,
			"description"		=> __("Insert Upcoming Events List","rhc"),
		...
		vc_map( array(
			...
			"category" 			=> $vc_category,
			"description"		=> __("Insert Venue Details Box","rhc"),
		...
		vc_map( array(
			...
			"category" 			=> $vc_category,
			"description"		=> __("Insert Event Details Box","rhc"),
			"params" 			=> $this->get_vc_map_params_for_detailbox(),
			"admin_enqueue_js" 	=> $scripts,
			"admin_enqueue_css" => $styles,
			"front_enqueue_js" 	=> $scripts,
		...
		vc_map( array(
			...
			"base" 				=> "rhc_dbox",
			"category" 			=> $vc_category,
			"description"		=> __("Create your own Custom Details Box","rhc"),
		...
		vc_map( array(
			...
			"category" 				=> $vc_category,
			"description"		=> __("TODO DESC: short description","rhc"),
		...
		$descriptions = array(
			'rhc_title' 		=> __("TODO DESC: short description","rhc"),
			'rhc_description'	=> __("TODO DESC: short description","rhc"),
			'btn_ical_feed' 	=> __("TODO DESC: short description","rhc"),
			'rhc_label'			=> __("TODO DESC: short description","rhc")
		);		
		
		foreach( array(
			'rhc_title' 		=> __('Event Title','rhc'),
			'rhc_description'	=> __('Event Description','rhc'),
		...
		vc_map( array(
			...
			"category" 			=> $vc_category,
			"description"		=> __("Insert Post Event Meta Data field","rhc"),
		...
		vc_map( array(
			...
			"show_settings_on_create" => false,
			"category" 			=> $vc_category,
			"description"		=> __("Insert Start Date and Time field","rhc"),
		...
		vc_map( array(
			...
			"show_settings_on_create" => false,
			"category" 			=> $vc_category,
			"description"		=> __("Insert Start Date field","rhc"),
			"params" 			=> $this->get_vc_map_params_for_rhc_date(),
			"admin_enqueue_js" 	=> $scripts,
			"admin_enqueue_css" => $styles,
			"front_enqueue_js" 	=> $scripts,
		...
		vc_map( array(
			...
			"show_settings_on_create" => false,
			"category" 			=> $vc_category,
			"description"		=> __("Insert Start Time field","rhc"),
			"params" 			=> $this->get_vc_map_params_for_rhc_date(),
			"admin_enqueue_js" 	=> $scripts,
			"admin_enqueue_css" => $styles,
			"front_enqueue_js" 	=> $scripts,
		...
		vc_map( array(
			...
			"show_settings_on_create" => false,
			"category" 			=> $vc_category,
			"description"		=> __("Insert End Date and Time field","rhc"),
			"params" 			=> $this->get_vc_map_params_for_rhc_date(),
		...
		vc_map( array(
			...
			"show_settings_on_create" => false,
			"category" 			=> $vc_category,
			"description"		=> __("Insert End Date field","rhc"),
			"params" 			=> $this->get_vc_map_params_for_rhc_date(),
		...
		vc_map( array(
			...
			"show_settings_on_create" => false,
			"category" 			=> $vc_category,
			"description"		=> __("Insert End Time field","rhc"),
			"params" 			=> $this->get_vc_map_params_for_rhc_date(),
		...
		vc_map( array(
			...
			"base" 				=> "rhc_gmap",
			"category" 			=> $vc_category,
			"description"		=> __("Insert a Venue Map","rhc"),
		...
		vc_map( array(
			...
			"class" 			=> "",
			"category" 			=> $vc_category,
			"description"		=> __("Insert an Event Image","rhc"),
		...
		foreach( array(
			...
			vc_map( array(
				...
				"base" 					=> $base,
				"category" 				=> $vc_category,
				"description"			=> __("TODO DESC: this description is shared by the loop shortcodes, use generic wording.","rhc"),				
...
*/			
		vc_map( array(
			...
			"category" 			=> $vc_category,
			"description"				=> __("Insert Venue Meta field","rhc"),				
			"show_settings_on_create" => true,
		...
		vc_map( array(
			...
			"category" 			=> $vc_category,
			"description"				=> __("Insert Organizer Meta field","rhc"),	
			"show_settings_on_create" => true,
		...
		vc_map( array(
			...
			"class" 			=> "",
			"category" 			=> $vc_category,
			"description"				=> __("Insert a Venue Image","rhc"),	
			"show_settings_on_create" => false,
		...
		vc_map( array(
			...
			"class" 			=> "",
			"category" 			=> $vc_category,
			"description"				=> __("Insert Venue Website field","rhc"),	
			"show_settings_on_create" => false,
		...
		vc_map( array(
			...
			"class" 			=> "",
			"category" 			=> $vc_category,
			"description"				=> __("Insert a Organizer Image","rhc"),	
			"show_settings_on_create" => false,
			"params" 			=> $this->get_vc_map_params_for_venue_image(),
			"admin_enqueue_js" 	=> $scripts,
			"admin_enqueue_css" => $styles,
		...
		vc_map( array(
			...
			"category" 			=> $vc_category,
			"description"				=> __("Insert a Organizer Website field","rhc"),	
			"show_settings_on_create" => false,
			"params" 			=> $this->get_vc_map_params_for_venue_website(),
			"admin_enqueue_js" 	=> $scripts,
			"admin_enqueue_css" => $styles,
	...
	function get_vc_map_params_for_rhc_image(){
		...
		add_filter('rhc_image_label', function( $image ){
			$map = array(
