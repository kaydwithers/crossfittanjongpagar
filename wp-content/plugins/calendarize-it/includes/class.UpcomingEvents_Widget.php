...
class UpcomingEvents_Widget extends WP_Widget {
	...
	function get_shortcode($widget_args,$sel){
		...
		foreach(array('class','feed', 'premiere', 'loading_method', 'template', 'post_type','calendar','venue','organizer','taxonomy','terms','auto','horizon','number','showimage','words','dayspast','fcdate_format','fctime_format','calendar_url','specific_date','specific_date_end','author_name') as $field ){
			$$field = isset($widget_args[$field])?$widget_args[$field]:'';
			//echo $field.": ".$$field."<BR />";
		}		
		
		if( $loading_method=='server' ){
			return $this->get_supe_shortcode( compact('class','feed', 'premiere', 'loading_method', 'template', 'post_type','calendar','venue','organizer','taxonomy','terms','auto','horizon','number','showimage','words','dayspast','fcdate_format','fctime_format','calendar_url','specific_date','specific_date_end','author_name'), $sel );
		}
...
//		echo "</prE>";
	...
	function update( $new_instance, $old_instance ) {
		$instance = array();
		foreach(array('taxonomy', 'terms', 'loading_method', 'template', 'post_type','calendar','venue','organizer','auto','premiere','title','fcdate_format','fctime_format','horizon','number','showimage','words','dayspast','calendar_url','specific_date','specific_date_end','author_name') as $field){
