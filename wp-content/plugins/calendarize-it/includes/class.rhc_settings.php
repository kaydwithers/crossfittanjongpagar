...
*/
		...
		if(current_user_can('manage_options')){
			...
			$t[$i]->options = array(
				...
				/* the fix that this option provided is now permanent.
				(object)array(
					'id'		=> 'bug_unwanted_venuebox',
					'label'		=> __('Unwanted content in venuebox','rhc'),
					'type'		=> 'yesno',
					'description'=> sprintf('<p>%s</p><p>%s</p>',
						__('Choose yes if unwanted content is rendered in the venuebox or any other taxonomy related field.','rhc'),
						__('Usually this is associated with plugins or themes that append content to a post, like sharing bars or forms.','rhc')
					),
					'default'	=> '0',
					'el_properties'	=> array(),
					'save_option'=>true,
