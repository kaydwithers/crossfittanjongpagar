jQuery(document).ready(function($){
	...
	$('.pinfo_quick_icon').on('click',function(e){
		var me = this;
		var fields = ['post_extrainfo_type','post_extrainfo_taxonomy','post_extrainfo_taxonomymeta','post_extrainfo_postmeta','post_extrainfo_label','post_extrainfo_value','post_extrainfo_nofollow'];
	...
	jQuery(document).ready(function($){
		...
		$('.rhc-extra-info-cell').each(function(i,inp){
			...
			$('.post_extrainfo_control .post_extrainfo_cell').each(function(j,control){
				...
				//--fill values
				$.each([['post_extrainfo_date_format','date_format'],['post_extrainfo_span','span'],['post_extrainfo_type','type'],['post_extrainfo_label','label'],['post_extrainfo_custom','custom'],['post_extrainfo_value','value'],['post_extrainfo_nofollow','nofollow'],['post_extrainfo_taxonomy','taxonomy'],['post_extrainfo_postmeta','postmeta']],function(i,s){
					if( _input_id==s[0] ){
