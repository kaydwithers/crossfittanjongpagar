...
if( 'module_righthere_css' == get_parent_class($this) ) :
		...
		$t[$i]->options = $this->add_backgroud_options( $t[$i]->options, array(
			...
			'selector'	=> ".fe-extrainfo-container$box_selector .fe-extrainfo-container2"		
		));		
		//--  --------------------------------		
	if($with_image):		
		$i++;
		...
		$t[$i]->options[] = (object)array(
				...
				'step'				=> 0.05,
				'holder_class'		=> '',
				'selector'			=> ".fe-extrainfo-container$box_selector .fe-extrainfo-holder .rhc-info-cell",
		...
		$t[$i]->options = $this->add_font_options( $t[$i]->options, array(
			...
			'selector'	=> ".fe-extrainfo-container$box_selector .fe-extrainfo-holder .fe-cell-label label.fe-extrainfo-label",
			'labels'	=> (object)array(
		...
		$t[$i]->options = $this->add_font_options( $t[$i]->options, array(
			...
			'selector'	=> ".fe-extrainfo-container$box_selector .fe-extrainfo-holder .rhc-info-cell:not(.fe-cell-label) label.fe-extrainfo-label",
			'labels'	=> (object)array(
		...
		$t[$i]->options = $this->add_font_options( $t[$i]->options, array(
			...
			'selector'	=> ".fe-extrainfo-container$box_selector .fe-extrainfo-holder .rhc-info-cell:not(.fe-cell-label) .fe-extrainfo-value",
			'labels'	=> (object)array(
		...
		$t[$i]->options = $this->add_font_options( $t[$i]->options, array(
			...
			'selector'	=> ".fe-extrainfo-container$box_selector .fe-extrainfo-holder .rhc-info-cell:not(.fe-cell-label) .fe-extrainfo-value a",
			'labels'	=> (object)array(
		...
		$t[$i]->options = $this->add_font_options( $t[$i]->options, array(
			...
			'selector'	=> ".fe-extrainfo-container$box_selector .fe-extrainfo-holder .dbox-description",
			'labels'	=> (object)array(
		...
		$i++;
		$t[$i]=(object)array();
		$t[$i]->id 			= $box_prefix.'-buttons'; 
		$t[$i]->label 		= __('Buttons','rhc');
		$t[$i]->options = array();	
		$t[$i]->options[] =(object)array(
				'id'				=> $box_prefix.'_button_background',
				'type'				=> 'css',
				'label'				=> __('Background color','rhc'),
				'input_type'		=> 'color_or_something_else',
				'opacity'			=> true,
				'selector'			=> ".fe-extrainfo-container$box_selector .fc-button.fc-state-default",
				'property'			=> 'background-color',
				'real_time'			=> true,
				'btn_clear'			=> true,
				'derived'			=> array()
		...
		$t[$i]->options = $this->add_font_options( $t[$i]->options, array(
			'prefix'	=> $box_prefix.'_button_font',
			'selector'	=> ".fe-extrainfo-container$box_selector .fc-button .fc-button-content, .fe-extrainfo-container$box_selector .fc-button .fc-button-content:hover",
			'labels'	=> (object)array(
				'family'	=> __('Font','rhc'),
				'size'		=> __('Size','rhc'),
				'color'		=> __('Color','rhc')				
		...
		$t[$i]->options = $this->add_border_options($t[$i]->options,array(
			'prefix'	=> $box_prefix.'_button_border',
			'selector'	=> ".fe-extrainfo-container$box_selector .fc-button.fc-state-default"
		));						
